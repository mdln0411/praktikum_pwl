        ...
        <div class="container">
            <div class="row">
                ...
                <div class="alert alert-light d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('todolist.show', $task->id) }}" class="btn btn-sm btn-secondary" title="Detail">View</a>
                        ...
                        <form action="{{ route('todolist.destroy', $task->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-success" title="Done" onclick="return confirm('Are you sure?')">Done</button>
                        </form>
                    </div>
                </div>
            </div>
